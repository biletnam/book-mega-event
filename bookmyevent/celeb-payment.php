...
if(isset($_REQUEST['Pay']))
{
	...
	$q = "insert into celeb_booking_table(price,singer,date,customer) values ('$price','$event','$da','$user')";
	mysqli_query($con , $q);
	?>
	<html>
 <head id="Head1">
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" /><link rel="icon" href="images/Title_Icon.png" type="image/gif" sizes="16x16" /><meta name="viewport" content="width=device-width" /><title>
 ...
 <nav>
	...
	<tr>
		<td>For Booking : <?php echo $event ;?></td>
	</tr>
	<tr>
		<td>On <?php echo $da ;?> </td>
	</tr>
	<tr>
		<td> Your Budget: <?php echo $price ;?> Rs /-</td>
	</tr>

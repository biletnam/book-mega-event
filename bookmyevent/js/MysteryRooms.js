...
$(document).ready(function () {
    ...
    var pageId = 0;
    LoadDataGetDatafor_TheHurtLocker(pageId);
    GetDatafor_AbductionMystery();
    GetDatafor_CabinMystery();
    ...
    $("#tab_kaboom").click(function () {
        ...
        $("#kaboom2").fadeOut(1000)
        $("#voucher").fadeOut(1000);
        GetDatafor_LockoutMystery(pageId);
    });
    ...
    function LoadDataGetDatafor_TheHurtLocker() {

        $('#init').empty();
        $(".DataLoader").show();
        $.ajax({
            type: "POST",
            url: "CluehuntwebService.asmx/GetDatafor_TheHurtLocker",
            data: "{pageId:'" + pageId + "'}",
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function (data) {
    ...
    function GetDatafor_LockoutMystery() {

        $('#init1').empty();
        $(".DataLoader").show();
        $.ajax({
            type: "POST",
            url: "CluehuntwebService.asmx/GetDatafor_LockoutMystery",
            data: "{pageId:'" + pageId + "'}",
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function (data) {
    ...
    function GetDatafor_AbductionMystery() {

        $('#init2').empty();
        $(".DataLoader").show();
        $.ajax({
            type: "POST",
            url: "CluehuntwebService.asmx/GetDatafor_Abduction",
            data: "{pageId:'" + pageId + "'}",
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function (data) {
    ...
    function GetDatafor_CabinMystery()
    {
        $('#init3').empty();
        $(".DataLoader").show();
        $.ajax({
            type: "POST",
            url: "CluehuntwebService.asmx/GetDatafor_CabinWoods",
            data: "{pageId:'" + pageId + "'}",
            contentType: "application/json; charset=utf-8",
            dataType: "",
            success: function (data) {

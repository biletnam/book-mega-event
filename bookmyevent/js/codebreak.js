...
$(document).ready(function () {
    ...
    var pageId = 0;
    LoadDataGetDatafor_Magi(pageId);
    ...
    $("#tab_kaboom1").click(function () {
        ...
        $("#kaboom3").fadeOut(1000)
        $("#voucher").fadeOut(1000);
        LoadDatafor_Magi_Explorers(pageId);
    });
    ...
    $('#Bandra').click(function () {
        ...
        $('#tab_kaboom3').hide();
        $('#kaboom3').hide();
        $('#EventPlaceAddress').text('D-150, Kamla Nagar, Delhi-7, India');
    });
    ...
    function LoadDataGetDatafor_Magi() {

        $('#init').empty();
        $(".DataLoader").show();
        $.ajax({
            type: "POST",
            url: "CluehuntwebService.asmx/GetDatafor_Magi",
            data: "{pageId:'" + pageId + "'}",
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function (data) {
    ...
    function LoadDatafor_Explorers() {

        $('#init1').empty();
        $(".DataLoader").show();
        $.ajax({
            type: "POST",
            url: "CluehuntwebService.asmx/GetDatafor_Explorers",
            data: "{pageId:'" + pageId + "'}",
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function (data) {
    ...
    function LoadDatafor_Magi_Explorers() {

        $('#init2').empty();
        $(".DataLoader").show();
        $.ajax({
            type: "POST",
            url: "CluehuntwebService.asmx/GetDatafor_magi_explorers",
            data: "{pageId:'" + pageId + "'}",
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function (data) {
    ...
    function LoadDatafor_Finalhour() {
        $('#init3').empty();
        $(".DataLoader").show();
        $.ajax({
            type: "POST",
            url: "CluehuntwebService.asmx/GetDatafor_FinalHour",
            data: "{pageId:'" + pageId + "'}",
            contentType: "application/json; charset=utf-8",
            dataType: "",
            success: function (data) {

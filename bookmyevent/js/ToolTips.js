...
var offsetfromcursorX = 12 //Customize x offset of tooltip 12
var offsetfromcursorY = 10 //Customize y offset of tooltip 10

var offsetdivfrompointerX = 10 //Customize x offset of tooltip DIV relative to pointer image 10
...
function ddrivetip(thetext) {
  //  alert(thetext);
    if (ns6 || ie) {
        ...
        $("#dhtmlpointer").css('display', 'block');

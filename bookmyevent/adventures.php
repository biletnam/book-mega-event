...
?>
<html>
<head id="Head1"><link rel="icon" href="images/Title_Icon.png" type="image/gif" sizes="16x16" /><meta name="viewport" content="width=device-width" /><title>
	Book My Event.com
</title>
...
?>
		...
		<a style="text-decoration:none;color:white;" href='showadventure.php?id=<?php echo $row['id'] ?>'>

...
if(isset($_REQUEST['Pay']))
{
	...
	$q = "insert into venue_booking_table(nameofevent,numberofperson,date,total,customer) values ('$event','$person','$da','$total','$user')";
	mysqli_query($con , $q);
	?>
	<html>
 <head id="Head1">
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" /><link rel="icon" href="images/Title_Icon.png" type="image/gif" sizes="16x16" /><meta name="viewport" content="width=device-width" /><title>
 ...
 <nav>
	...
	<tr>
		<td>Thanks <?php echo $user ;?> </td>
	</tr>
	<tr>
		<td>For Booking : <?php echo $event ;?> for 1 week for <?php echo $person; ?> Person</td>
	</tr>
	<tr>
		<td>On <?php echo $da ;?> </td>
	</tr>
	<tr>
		<td> we received: <?php echo $total ;?> Rs /-</td>
	</tr>
